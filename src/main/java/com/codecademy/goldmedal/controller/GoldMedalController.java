...
public class GoldMedalController {
    ...
    private CountryMedalsListResponse getCountryMedalsListResponse(String countryName, String sortBy, boolean ascendingOrder) {
        List<GoldMedal> medalsList = switch (sortBy) {
            case "year" -> ascendingOrder ? this.goldMedalRepository.getByCountryOrderByYearAsc(countryName)
                    : this.goldMedalRepository.getByCountryOrderByYearDesc(countryName);// TODO: list of medals sorted by year in the given order
            case "season" -> ascendingOrder ? this.goldMedalRepository.getByCountryOrderBySeasonAsc(countryName)
                    : this.goldMedalRepository.getByCountryOrderBySeasonDesc(countryName); // TODO: list of medals sorted by season in the given order
            case "city" -> ascendingOrder ? this.goldMedalRepository.getByCountryOrderByCityAsc(countryName)
                    : this.goldMedalRepository.getByCountryOrderByCityDesc(countryName); // TODO: list of medals sorted by city in the given order
            case "name" -> ascendingOrder ? this.goldMedalRepository.getByCountryOrderByNameAsc(countryName)
                    : this.goldMedalRepository.getByCountryOrderByNameDesc(countryName);  // TODO: list of medals sorted by athlete's name in the given order
            case "event" -> ascendingOrder ? this.goldMedalRepository.getByCountryOrderByEventAsc(countryName)
                    : this.goldMedalRepository.getByCountryOrderByEventDesc(countryName);// TODO: list of medals sorted by event in the given order
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        ...
        var summerWins = this.goldMedalRepository.getByCountryAndSeasonOrderByYear(countryName, "Summer");// TODO: get the collection of wins at the Summer Olympics, sorted by year in ascending order
        ...
        var yearFirstSummerWin = !summerWins.isEmpty() ? summerWins.getFirst().getYear() : null;

        var winterWins = this.goldMedalRepository.getByCountryAndSeasonOrderByYear(countryName, "Winter");/// TODO: get the collection of wins at the Winter Olympics
        ...
        var numberEventsWonByFemaleAthletes = this.goldMedalRepository.countByCountryAndGender(countryName, "Women"); // TODO: get the number of wins by female athletes
        var numberEventsWonByMaleAthletes = this.goldMedalRepository.countByCountryAndGender(countryName, "Men");// TODO: get the number of wins by male athletes
    ...
    private List<CountrySummary> getCountrySummaries(String sortBy, boolean ascendingOrder) {
        ...
        switch (sortBy) {
            ...
            case "gdp":
                ...
                break;
            case "population":
                countries = ascendingOrder ? this.countryRepository.getAllByOrderByPopulationAsc()
                        :this.countryRepository.getAllByOrderByPopulationDesc(); // TODO: list of countries sorted by population in the given order
                break;
            case "medals":
            default:
                countries = (List<Country>) this.countryRepository.findAll(); // TODO: list of countries in any order you choose; for sorting by medal count, additional logic below will handle that
                break;
        }
